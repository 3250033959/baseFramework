...
public abstract class BGARefreshViewHolder {
     ...
     * 是否开启下拉刷新
     */
    public boolean mIsRefreshingEnabled = true;
    /**
     * 整个加载更多控件的背景颜色资源id
     */
     ...
     * @param isRefreshingEnabled 下拉刷新是否可用
     */
    public BGARefreshViewHolder(Context context, boolean isLoadingMoreEnabled,boolean isRefreshingEnabled) {
        mContext = context;
        mIsLoadingMoreEnabled = isLoadingMoreEnabled;
        mIsRefreshingEnabled = isRefreshingEnabled;
    }
