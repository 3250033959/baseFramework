...
public class BGANormalRefreshViewHolder extends BGARefreshViewHolder {
    ...
    public String getmPullDownRefreshText() {
        return mPullDownRefreshText;
    }
    ...
    public String getmReleaseRefreshText() {
        return mReleaseRefreshText;
    }
    ...
    public String getmRefreshingText() {
        return mRefreshingText;
    }
    ...
    public BGANormalRefreshViewHolder(Context context, boolean isLoadingMoreEnabled,boolean isRefreshEnabled) {
        super(context, isLoadingMoreEnabled,isRefreshEnabled);
        initAnimation();
    }
