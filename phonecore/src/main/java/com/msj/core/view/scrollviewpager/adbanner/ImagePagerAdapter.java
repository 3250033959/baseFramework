package com.msj.core.view.scrollviewpager.adbanner;
...
//		this.bannerList = bannerList;
    ...
    public View getView(final int position, View convertView,
        ...
        final String banner = this.bannerList.get(getPosition(position));

        ImageUtils.setSimpleDrawViewBy1618WithoutFace(holder.imageView, banner, 550, 0);
