...
import com.msj.core.utils.java.StringUtils;
import com.msj.core.utils.java.ValidateUtils;


/**
 * @author Vincent.M mengshaojie@188.com on 16/09/19.
...
public class TipEditText extends RelativeLayout {
    ...
    private int labelVisible = 1;

    private static final int LABEL_VISIBLE = 0;

    private static final int LABEL_INVISIBLE = 4;

    private static final int LABEL_GONE = 8;
    ...
    public TipEditText(Context context, AttributeSet attrs) {
        ...
        if (textView == null || editText == null) {
             ...
             * label
             */
            labelVisible = attributes.getInt(R.styleable.TipEditText_tipedit_label_visible,0);

            label_width = attributes.getDimension(R.styleable.TipEditText_tipedit_label_width,80);

            label_text = attributes.getString(R.styleable.TipEditText_tipedit_label_text);
    ...
    private void init() {
        ...
        label.setWidth((int)label_width);
        label.setText(label_text);
        switch (labelVisible){
            case LABEL_VISIBLE:
                label.setVisibility(View.VISIBLE);
                break;
            case LABEL_INVISIBLE:
    ...
    private TextWatcher mobileWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (count == 11) {
                if (ValidateUtils.isMobileNO(s.toString(),"86")) {
                    setTrue();
                } else {
                    setFalse(false);
                }
