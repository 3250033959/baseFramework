...
/***
 * @title 重写ListView 实现向左滑动拉出按钮 类似老版微信滑动删除
 */
public class SwipeListView extends ListView {
    ...
    public SwipeListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,  
                R.styleable.swipelistviewstyle1);
        
      //获取自定义属性和默认�? 
      mRightViewWidth = (int) mTypedArray.getDimension(R.styleable.swipelistviewstyle1_right_width1, 200);   
