package com.msj.core.view.wheelview;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TEXT_SIZE = (int) context.getResources().getDimension(
                R.dimen.nineSize);
        initData(context);
    }
...
//					valuePaint));
        ...
        if (recalculate) {
            ...
            int pureWidth = width - LABEL_OFFSET;
            if (pureWidth <= 0) {
