package com.msj.core.utils.android.richtext;
...
import com.msj.core.utils.java.UrlUtils;
 ...
 * @desc 图文混排工具类,包括解析html路径,并可点击,支持gif图片,使用调用setImageText即可,这里的html传的是encode后的,如果使用非encode,请自行修改代码,参考https://centmeng.github.io/2016/07/19/TextView%E5%9B%BE%E6%96%87%E6%B7%B7%E6%8E%92/
 */
        ...
        if(text instanceof Spannable){
            ...
            if(isShow){
                ...
                while (matcher.find()) {
                    ...
                    if(!UrlUtils.isStartWithHttp(href)){
                        href = UrlUtils.addHttp(href);
                    }
